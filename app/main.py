...
def _license_guard(
    ...
    *,
    ...
    try:
        return license_check(license_key, increment=increment, need_visuals=need_visuals)
...
def _license_usage_for_visuals(license_key: str, assets, *, increment: bool) -> dict:
    if increment and _billable_visual_assets(assets):
        return _license_guard(license_key, increment=True, need_visuals=True)
...
async def repurpose(
    ...
    _license_guard(client_license, increment=False, need_visuals=should_generate_visuals)
